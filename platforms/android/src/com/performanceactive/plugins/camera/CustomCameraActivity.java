...
public class CustomCameraActivity extends Activity {
    ...
    private void createtoggleButton() {
        toggleButton = new ImageButton(getApplicationContext());
        setBitmap(toggleButton, "toggle_button.png");
        toggleButton.setBackgroundColor(Color.TRANSPARENT);
        toggleButton.setScaleType(ScaleType.FIT_CENTER);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(dpToPixels(75), dpToPixels(75));
        layoutParams.addRule(RelativeLayout.ALIGN_PARENT_TOP);
        layoutParams.addRule(RelativeLayout.CENTER_HORIZONTAL);
        layoutParams.bottomMargin = dpToPixels(10);
